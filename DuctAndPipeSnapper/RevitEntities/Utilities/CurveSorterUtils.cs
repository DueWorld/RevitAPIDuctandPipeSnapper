namespace DuctAndPipeSnapper.Helper
{
    ...
    class CurveSorterUtils
    {
        ...
        /// <summary>
        /// Convert a given length in feet to millimeters.
        /// </summary>
        ...
        /// </summary>
        public static double MetreToFoot(double length)
        {
            return length / _footToMeter;
        }

        /// <summary>
        /// Convert a given length in millimeters to feet.
        /// </summary>
        ...
        /// <summary>
        /// Convert a given point or vector from millimeters to feet.
        /// </summary>
    ...
    return e;
      ...
      return elementsByName.First<Element>();
        ...
        public static bool IsCurveEqual(Curve c1, Curve c2)
        {
            ...
            return (IsPointEqual(startPoint1,startPoint2) && IsPointEqual(endPoint1,endPoint2));
        }

        /// <summary>
        /// Equates between two points of REVIT API.
        /// </summary>
        /// <param name="p1">First point.</param>
        /// <param name="p2">Second point.</param>
        /// <returns>Boolean indicating the equality of 2 points W.R.T their coordinates</returns>
        public static bool IsPointEqual(XYZ p1, XYZ p2)
        {
